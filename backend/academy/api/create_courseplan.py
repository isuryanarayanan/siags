    ...
    def __init__(self, params):
        ...
        try:
            ...
            if user.mode == 2:
                ...
                # create course plan with no data
                self.course_plan = plan(
                    name=params.data['name'],
                    code=self.getCodeThatDontExist(),
...
class CreateCoursePlan(APIView):
    permission_classes = (IsAuthenticated,)

    def post(self, request):
        # Create the engine.
        Engine = CreateCoursePlanEngine(request)
        # Respond.
